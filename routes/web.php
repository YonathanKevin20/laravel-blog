...
Route::group(['prefix'=>'back','middleware'=>'auth'],function() {
	...
	Route::resource('category','CategoryController')->middleware(['chief','leader']);
	...
	Route::get('getcategory','CategoryController@getcategory')->name('data.category')->middleware(['chief','leader']);
